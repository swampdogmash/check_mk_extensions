...
su - cmk -c "/omd/sites/cmk/bin/mkp template nut"

# otherwise /source is not accepted
git config --global --add safe.directory $SOURCE

# modify extension config file with correct version number, author etc.
/build-modify-extension.py $SOURCE $CMK/tmp/check_mk/nut.manifest.temp
...
su - cmk -c "/omd/sites/cmk/bin/mkp package $CMK/tmp/check_mk/nut.manifest.temp"
